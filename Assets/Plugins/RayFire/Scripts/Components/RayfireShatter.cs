...
namespace RayFire
{
    ...
    public class RayfireShatter : MonoBehaviour
    {
        ...
        public void Fragment(Transform parent, LayerMask fragmentLayer, FragLastMode fragmentMode = FragLastMode.New)
        {
            System.Diagnostics.Stopwatch stopWatch = new System.Diagnostics.Stopwatch();
            stopWatch.Start();
            ...
            if (fragmentMode == FragLastMode.New)
            {
                fragmentsLast = CreateFragments(fragmentLayer, parent);
            }
        ...
        List<GameObject> CreateFragments(LayerMask fragmentLayer, Transform root = null)
        {
            // No mesh were cached
            if (meshes == null)
                return null;
