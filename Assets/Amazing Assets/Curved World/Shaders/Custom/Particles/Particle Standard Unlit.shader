...
Shader "Amazing Assets/Curved World/Particles/Standard Unlit"
{
    Properties
    {
[HideInInspector][CurvedWorldBendSettings]	  _CurvedWorldBendSettings("0,4,5|1|1", Vector) = (0, 0, 0, 0)
...
#pragma shader_feature_local CURVEDWORLD_BEND_TYPE_CLASSICRUNNER_X_POSITIVE CURVEDWORLD_BEND_TYPE_LITTLEPLANET_X CURVEDWORLD_BEND_TYPE_LITTLEPLANET_Y
